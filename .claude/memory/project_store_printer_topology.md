...
- **라벨 프린터**: USB 직결, 벤더 2종 — Caysn/REXOD(autoreplyprint SDK, CP_Port_OpenUsb) + BIXOLON XD5-40d(BIXOLON Label SDK, 2026-07-23 Android 추가, [[project-bixolon-xd5-40d]]). VID 자동감지 라우팅(NativeMethodHandler, BIXOLON 0x1504 우선), VID:PID 화이트리스트.
