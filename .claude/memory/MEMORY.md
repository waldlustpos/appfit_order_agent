...
- [AppFit 설치 모니터링 도구](project_appfit_migration_monitoring.md) — Sunmi CSV → SQLite 일별 추적. 구앱·appfit 공존이라 "전환" 아닌 설치 여부. 코호트 freeze 필수, sticky 판정. 대상앱을 매머드 전용 빌드로 교체 결정(2026-08-19, 미적용)
