...
- [AppFit 설치 모니터링 도구](project_appfit_migration_monitoring.md) — Sunmi CSV → SQLite 일별 추적. 코호트 freeze 필수, sticky 판정. 매머드 전용 빌드 전환 완료, 8/18 스냅샷도 0대=의도됨(배포 당일이라 정상). 첨부 대용량 CSV는 Downloads 원본 cp (2026-08-19)
