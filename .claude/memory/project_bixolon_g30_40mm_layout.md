...
description: BIXOLON G30(UPOS) 라벨프린터 40mm/58mm 레이아웃 완료(유효폭 실측 확정). Windows 이식은 별도 노트로 완료.
metadata: 
  node_type: memory
  type: project
  originSessionId: 53a45610-6eb5-4053-b969-874bbd803dd5
  modified: 2026-09-03T07:39:27.039Z
---
...
- Windows 이식 완료(2026-09-03) — **BXLPAPI 가 아니라 usbprint 직결 ESC/POS 였다**. 라우터에 G30 분기 추가 + 490/600 하드코딩은 디코드 치수로 대체됨: [[project-g30-windows-escpos-port]].
