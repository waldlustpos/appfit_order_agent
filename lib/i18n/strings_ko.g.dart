...
class Translations with BaseTranslations<AppLocale, Translations> {
  ...
  late final Translations$common$ko common =
      Translations$common$ko.internal(_root);
  late final Translations$login$ko login =
      Translations$login$ko.internal(_root);
  late final Translations$settings$ko settings =
      Translations$settings$ko.internal(_root);
  late final Translations$home$ko home = Translations$home$ko.internal(_root);
  late final Translations$app_bar$ko app_bar =
      Translations$app_bar$ko.internal(_root);
  late final Translations$order_status$ko order_status =
      Translations$order_status$ko.internal(_root);
  late final Translations$order_history$ko order_history =
      Translations$order_history$ko.internal(_root);
  late final Translations$product_mgmt$ko product_mgmt =
      Translations$product_mgmt$ko.internal(_root);
  late final Translations$order$ko order =
      Translations$order$ko.internal(_root);
  late final Translations$order_detail$ko order_detail =
      Translations$order_detail$ko.internal(_root);
  late final Translations$dialog$ko dialog =
      Translations$dialog$ko.internal(_root);
  late final Translations$drawer$ko drawer =
      Translations$drawer$ko.internal(_root);
  late final Translations$membership$ko membership =
      Translations$membership$ko.internal(_root);
  late final Translations$kds$ko kds = Translations$kds$ko.internal(_root);
  late final Translations$receipt$ko receipt =
      Translations$receipt$ko.internal(_root);
  late final Translations$label_category_select$ko label_category_select =
      Translations$label_category_select$ko.internal(_root);
}
...
class Translations$common$ko {
  ...
  late final Translations$common$api_error$ko api_error =
      Translations$common$api_error$ko.internal(_root);
}
...
class Translations$login$ko {
  ...
  late final Translations$login$tabs$ko tabs =
      Translations$login$tabs$ko.internal(_root);
  late final Translations$login$kds_notice$ko kds_notice =
      Translations$login$kds_notice$ko.internal(_root);
  late final Translations$login$overlay_permission$ko overlay_permission =
      Translations$login$overlay_permission$ko.internal(_root);
}
...
class Translations$settings$ko {
  ...
  late final Translations$settings$mode_switch$ko mode_switch =
      Translations$settings$mode_switch$ko.internal(_root);
  late final Translations$settings$auto_start$ko auto_start =
      Translations$settings$auto_start$ko.internal(_root);
  late final Translations$settings$auto_receipt$ko auto_receipt =
      Translations$settings$auto_receipt$ko.internal(_root);
  late final Translations$settings$print_order$ko print_order =
      Translations$settings$print_order$ko.internal(_root);
  late final Translations$settings$builtin_printer$ko builtin_printer =
      Translations$settings$builtin_printer$ko.internal(_root);
  late final Translations$settings$external_printer$ko external_printer =
      Translations$settings$external_printer$ko.internal(_root);
  late final Translations$settings$label_printer$ko label_printer =
      Translations$settings$label_printer$ko.internal(_root);
  late final Translations$settings$label_qr$ko label_qr =
      Translations$settings$label_qr$ko.internal(_root);
  late final Translations$settings$volume$ko volume =
      Translations$settings$volume$ko.internal(_root);
  late final Translations$settings$sound$ko sound =
      Translations$settings$sound$ko.internal(_root);
  late final Translations$settings$alert_count$ko alert_count =
      Translations$settings$alert_count$ko.internal(_root);
  late final Translations$settings$print_count$ko print_count =
      Translations$settings$print_count$ko.internal(_root);
  late final Translations$settings$language$ko language =
      Translations$settings$language$ko.internal(_root);
  late final Translations$settings$theme$ko theme =
      Translations$settings$theme$ko.internal(_root);
  late final Translations$settings$dual_monitor$ko dual_monitor =
      Translations$settings$dual_monitor$ko.internal(_root);
  late final Translations$settings$currency$ko currency =
      Translations$settings$currency$ko.internal(_root);
  late final Translations$settings$display_rotate$ko display_rotate =
      Translations$settings$display_rotate$ko.internal(_root);
  late final Translations$settings$order_type_badge$ko order_type_badge =
      Translations$settings$order_type_badge$ko.internal(_root);
  late final Translations$settings$print_show_order_type$ko
      print_show_order_type =
      Translations$settings$print_show_order_type$ko.internal(_root);
  late final Translations$settings$order_source_color$ko order_source_color =
      Translations$settings$order_source_color$ko.internal(_root);
  late final Translations$settings$kds_ignore_status$ko kds_ignore_status =
      Translations$settings$kds_ignore_status$ko.internal(_root);
  late final Translations$settings$kds_accept_orders$ko kds_accept_orders =
      Translations$settings$kds_accept_orders$ko.internal(_root);
  late final Translations$settings$label_category_filter$ko
      label_category_filter =
      Translations$settings$label_category_filter$ko.internal(_root);
  late final Translations$settings$label_paper$ko label_paper =
      Translations$settings$label_paper$ko.internal(_root);
  late final Translations$settings$developer_options$ko developer_options =
      Translations$settings$developer_options$ko.internal(_root);
  late final Translations$settings$kiosk$ko kiosk =
      Translations$settings$kiosk$ko.internal(_root);
  late final Translations$settings$pos$ko pos =
      Translations$settings$pos$ko.internal(_root);
  late final Translations$settings$local_server$ko local_server =
      Translations$settings$local_server$ko.internal(_root);
  late final Translations$settings$connection$ko connection =
      Translations$settings$connection$ko.internal(_root);
  late final Translations$settings$soundgraph$ko soundgraph =
      Translations$settings$soundgraph$ko.internal(_root);
  late final Translations$settings$app_update$ko app_update =
      Translations$settings$app_update$ko.internal(_root);
  late final Translations$settings$log_collection$ko log_collection =
      Translations$settings$log_collection$ko.internal(_root);
}
...
class Translations$home$ko {
  ...
  // Translations
  late final Translations$home$tabs$ko tabs =
      Translations$home$tabs$ko.internal(_root);
...
class Translations$order$ko {
  ...
  late final Translations$order$payment_method$ko payment_method =
      Translations$order$payment_method$ko.internal(_root);
  late final Translations$order$discount_type$ko discount_type =
      Translations$order$discount_type$ko.internal(_root);
...
class Translations$dialog$ko {
  ...
  // Translations
  late final Translations$dialog$status_change$ko status_change =
      Translations$dialog$status_change$ko.internal(_root);
  late final Translations$dialog$exit$ko exit =
      Translations$dialog$exit$ko.internal(_root);
  late final Translations$dialog$update$ko update =
      Translations$dialog$update$ko.internal(_root);
}
...
class Translations$membership$ko {
  ...
  late final Translations$membership$search$ko search =
      Translations$membership$search$ko.internal(_root);
  late final Translations$membership$customer$ko customer =
      Translations$membership$customer$ko.internal(_root);
  late final Translations$membership$tabs$ko tabs =
      Translations$membership$tabs$ko.internal(_root);
  late final Translations$membership$history$ko history =
      Translations$membership$history$ko.internal(_root);
  late final Translations$membership$dialog$ko dialog =
      Translations$membership$dialog$ko.internal(_root);
  late final Translations$membership$keypad$ko keypad =
      Translations$membership$keypad$ko.internal(_root);
}
...
class Translations$kds$ko {
  ...
  // Translations
  late final Translations$kds$tabs$ko tabs =
      Translations$kds$tabs$ko.internal(_root);
  ...
  late final Translations$kds$sort$ko sort =
      Translations$kds$sort$ko.internal(_root);
...
class Translations$login$kds_notice$ko {
  ...
  /// ko: '주방모니터(KDS)는 기본적으로 신규 주문을 직접 수신하지 않고 보기만 합니다. 일반적으로 단말이 두 대 이상인 환경에서 사용합니다. 카운터 접수 기기 없이 주방모니터만으로 운영하려면, 로그인 후 설정 > 모드 설정에서 '주문 접수'를 ON 해야 합니다. 다른 주문 접수 프로그램과 중복 사용되지 않도록 확인해주세요.'
  String get content =>
      '주방모니터(KDS)는 기본적으로 신규 주문을 직접 수신하지 않고 보기만 합니다.\n일반적으로 단말이 두 대 이상인 환경에서 사용합니다.\n카운터 접수 기기 없이 주방모니터만으로 운영하려면, 로그인 후 설정 > 모드 설정에서 \'주문 접수\'를 ON 해야 합니다.\n다른 주문 접수 프로그램과 중복 사용되지 않도록 확인해주세요.';
}
...
class Translations$settings$theme$ko {
  ...
  late final Translations$settings$theme$options$ko options =
      Translations$settings$theme$options$ko.internal(_root);
}
...
class Translations$settings$kds_ignore_status$ko {
  ...
  String get desc =>
      '다른 주방모니터(KDS)에서 픽업 요청 등 진행상태를 변경해도 내 화면의 주문이 새로고침되지 않습니다. (진행상태 최신화를 수동으로 통제하고 싶을 때 사용)';
}
...
class Translations$settings$kds_accept_orders$ko {
  ...
  String get desc =>
      '주방모니터(KDS)에서 주문을 직접 자동접수처리 합니다. 반드시 다른 메인주문 접수 프로그램과 중복 사용 되지 않도록 확인해주세요';
...
class Translations$settings$label_category_filter$ko {
  ...
  String desc_selected(
      ...
      '${total}개 중 ${count}개 카테고리만 출력합니다 — ${names}';
...
class Translations$settings$developer_options$ko {
  ...
  late final Translations$settings$developer_options$appfit_test$ko
      appfit_test =
      Translations$settings$developer_options$appfit_test$ko.internal(_root);
}
...
class Translations$settings$kiosk$ko {
  ...
  String get sound_desc =>
      '키오스크 주문 수신 시 주문서 출력과 알림음을 재생합니다. 화면 표시 설정과 별개로 동작합니다.';
  ...
  String get auto_accept_desc =>
      '키오스크 주문은 \'픽업 오더 자동 접수\' 설정과 무관하게 항상 즉시 접수합니다.';
}
...
class Translations$settings$pos$ko {
  ...
  String get sound_desc =>
      'POS 주문 수신 시 주문서 출력과 알림음을 재생합니다. 화면 표시 설정과 별개로 동작합니다.';
}
...
class Translations$dialog$status_change$ko {
  ...
  String bulk_categories({required Object names}) =>
      '이 상품은 ${names} 카테고리에 함께 등록되어 있어 모두 변경됩니다.';
...
class Translations$membership$dialog$ko {
  ...
  String get coupon_code_looks_like_phone =>
      '전화번호가 입력되어 있습니다. 회원 조회를 하시려면 [회원조회]를 눌러주세요. 쿠폰을 사용하시려면 쿠폰 코드를 입력해주세요.';
