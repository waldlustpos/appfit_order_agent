...
class Translations$common$ko {
  ...
  late final Translations$common$sync$ko sync =
      Translations$common$sync$ko.internal(_root);
}
...
class Translations$settings$ko {
  ...
  late final Translations$settings$label_filter$ko label_filter =
      Translations$settings$label_filter$ko.internal(_root);
