...
///
/// Locales: 3
/// Strings: 1286 (428 per locale)
///
/// Built on 2026-06-29 at 08:08 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final _StringsReceiptKo receipt = _StringsReceiptKo._(_root);
}
...
class _StringsSettingsKo {
	...
	late final _StringsSettingsDualMonitorKo dual_monitor = _StringsSettingsDualMonitorKo._(_root);
...
// Path: receipt
class _StringsReceiptKo {
	_StringsReceiptKo._(this._root);
...
class _StringsSettingsDualMonitorKo {
	_StringsSettingsDualMonitorKo._(this._root);
...
class _StringsEn extends Translations {
	...
	@override late final _StringsReceiptEn receipt = _StringsReceiptEn._(_root);
}
...
class _StringsSettingsEn extends _StringsSettingsKo {
	...
	@override late final _StringsSettingsDualMonitorEn dual_monitor = _StringsSettingsDualMonitorEn._(_root);
...
// Path: receipt
class _StringsReceiptEn extends _StringsReceiptKo {
	_StringsReceiptEn._(_StringsEn root) : this._root = root, super._(root);
...
// Path: settings.dual_monitor
class _StringsSettingsDualMonitorEn extends _StringsSettingsDualMonitorKo {
	_StringsSettingsDualMonitorEn._(_StringsEn root) : this._root = root, super._(root);
...
class _StringsJa extends Translations {
	...
	@override late final _StringsReceiptJa receipt = _StringsReceiptJa._(_root);
}
...
class _StringsSettingsJa extends _StringsSettingsKo {
	...
	@override late final _StringsSettingsDualMonitorJa dual_monitor = _StringsSettingsDualMonitorJa._(_root);
...
// Path: receipt
class _StringsReceiptJa extends _StringsReceiptKo {
	_StringsReceiptJa._(_StringsJa root) : this._root = root, super._(root);
...
// Path: settings.dual_monitor
class _StringsSettingsDualMonitorJa extends _StringsSettingsDualMonitorKo {
	_StringsSettingsDualMonitorJa._(_StringsJa root) : this._root = root, super._(root);
