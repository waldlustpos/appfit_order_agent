...
/// 모두 서빙하므로 OTA 채널도 `_release` 하나만 사용한다. 서버(live/japanLive)는
...
class OtaConfig {
  ...
  static const String versionUrl =
      '${_base}appfit_order_agent_release_version.json';
  static const String downloadUrl = '${_base}appfit_order_agent_release.apk';
}
